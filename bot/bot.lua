...
function create_config( )
	...
	if server_user:match("^root$") then
		Poinshtan.Bot = '/root/PoinshtanBot'
	elseif not server_user:match("^root$") then
		Poinshtan.Bot = '/home/'..server_user..'/PoinshtanBot'
	end
  ...
  config = {
    ...
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..Poinshtan.Bot..'/data/moderation.json'},
    info_text = [[*》Poinshtan Helper*
]],
  }
