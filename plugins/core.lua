--Begin Core.lua By #Poinshtan.Bot
...
local lang = redis:get(hash) 
     if not lang then
	 text = '_به_*تنظیمات گروه*_خوش آمدید_'
	keyboard = {} 
...
local settings = data[tostring(GP_id)]["settings"]
 ...
 text = '_Welcome To_ *More Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = '> Flood Sensitivity ', callback_data = 'Poinshtan.Bot'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="Poinshtan.Bot"},
			{text = "➖", callback_data='/flooddown:'..GP_id}
		},
		{
			{text = '> Character Sensitivity ', callback_data = 'Poinshtan.Bot'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="Poinshtan.Bot"},
			{text = "➖", callback_data='/chardown:'..GP_id}
		},
		{
			{text = '> Flood Check Time ', callback_data = 'Poinshtan.Bot'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="Poinshtan.Bot"},
 ...
 text = '_به تنظیمات بیشتر خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = '> حداکثر پیام های مکرر ', callback_data = 'Poinshtan.Bot'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="Poinshtan.Bot"},
		...
		{
			{text = '> حداکثر حروف مجاز ', callback_data = 'Poinshtan.Bot'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="Poinshtan.Bot"},
		...
		{
			{text = '> زمان بررسی پیام های مکرر ', callback_data = 'Poinshtan.Bot'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="Poinshtan.Bot"},
...
local lang = redis:get(hash) 
 ...
 text = '_Welcome To_ *Group Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = "> Lock Edit", callback_data='Poinshtan.Bot'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id}
		},
		{
			{text = "> Lock Link", callback_data='Poinshtan.Bot'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = "> Lock Tags", callback_data='Poinshtan.Bot'}, 
			{text = lock_tag, callback_data="/locktags:"..GP_id}
		},
		{
			{text = "> Lock Join", callback_data='Poinshtan.Bot'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "> Lock Flood", callback_data='Poinshtan.Bot'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "> Lock Spam", callback_data='Poinshtan.Bot'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "> Lock Mention", callback_data='Poinshtan.Bot'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id}
		},
		{
			{text = "> Lock Arabic", callback_data='Poinshtan.Bot'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = "> Lock Webpage", callback_data='Poinshtan.Bot'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id}
		},
		{
			{text = "> Lock Markdown", callback_data='Poinshtan.Bot'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = "> Lock Pin", callback_data='Poinshtan.Bot'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "> Lock Bots", callback_data='Poinshtan.Bot'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		{
			{text = "> Group Welcome", callback_data='Poinshtan.Bot'}, 
 ...
 text = '_به تنظیمات گروه خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = "> قفل ویرایش", callback_data='Poinshtan.Bot'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id}
		},
		{
			{text = "> قفل لینک", callback_data='Poinshtan.Bot'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = "> قفل تگ", callback_data='Poinshtan.Bot'}, 
			{text = lock_tag, callback_data="/locktags:"..GP_id}
		},
		{
			{text = "> قفل ورود", callback_data='Poinshtan.Bot'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "> قفل پیام های مکرر", callback_data='Poinshtan.Bot'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "> قفل هرزنامه", callback_data='Poinshtan.Bot'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "> قفل فراخوانی", callback_data='Poinshtan.Bot'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id}
		},
		{
			{text = "> قفل عربی", callback_data='Poinshtan.Bot'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = "> قفل صفحات وب", callback_data='Poinshtan.Bot'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id}
		},
		{
			{text = "> قفل فونت", callback_data='Poinshtan.Bot'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = "> قفل سنجاق کردن", callback_data='Poinshtan.Bot'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "> قفل ربات ها", callback_data='Poinshtan.Bot'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		{
			{text = "> خوشآمد گویی", callback_data='Poinshtan.Bot'}, 
			{text = group_welcone, callback_data="/welcome:"..GP_id}
		},
		{
...
local lang = redis:get(hash) 
   ...
   if not lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "> Mute All", callback_data='Poinshtan.Bot'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = "> Mute Gifs", callback_data='Poinshtan.Bot'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = "> Mute Text", callback_data='Poinshtan.Bot'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = "> Mute Inline", callback_data='Poinshtan.Bot'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = "> Mute Game", callback_data='Poinshtan.Bot'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = "> Mute Photo", callback_data='Poinshtan.Bot'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = "> Mute Video", callback_data='Poinshtan.Bot'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = "> Mute Audio", callback_data='Poinshtan.Bot'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = "> Mute Voice", callback_data='Poinshtan.Bot'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = "> Mute Sticker", callback_data='Poinshtan.Bot'}, 
			{text = mute_sticker, callback_data="/mutesticker:"..GP_id}
		},
		{
			{text = "> Mute Contact", callback_data='Poinshtan.Bot'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = "> Mute Forward", callback_data='Poinshtan.Bot'}, 
			{text = mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = "> Mute Location", callback_data='Poinshtan.Bot'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = "> Mute Document", callback_data='Poinshtan.Bot'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = "> Mute TgService", callback_data='Poinshtan.Bot'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "> Mute Keyboard", callback_data='Poinshtan.Bot'}, 
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "> بیصدا همه", callback_data='Poinshtan.Bot'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = "> بیصدا تصاویر متحرک", callback_data='Poinshtan.Bot'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = "> بیصدا متن", callback_data='Poinshtan.Bot'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = "> بیصدا اینلاین", callback_data='Poinshtan.Bot'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = "> بیصدا بازی", callback_data='Poinshtan.Bot'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = "> بیصدا عکس", callback_data='Poinshtan.Bot'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = "> بیصدا فیلم", callback_data='Poinshtan.Bot'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = "> بیصدا آهنگ", callback_data='Poinshtan.Bot'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = "> بیصدا صدا", callback_data='Poinshtan.Bot'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = "> بیصدا استیکر", callback_data='Poinshtan.Bot'}, 
			{text = mute_sticker, callback_data="/mutesticker:"..GP_id}
		},
		{
			{text = "> بیصدا مخاطب", callback_data='Poinshtan.Bot'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = "> بیصدا نقل و قول", callback_data='Poinshtan.Bot'}, 
			{text = mutes.mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = "> بیصدا موقعیت", callback_data='Poinshtan.Bot'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = "> بیصدا فایل", callback_data='Poinshtan.Bot'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = "> بیصدا خدمات تلگرام", callback_data='Poinshtan.Bot'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "> بیصدا کیبورد", callback_data='Poinshtan.Bot'}, 
			{text = mute_keyboard, callback_data="/mutekeyboard:"..GP_id}
		},
		{
			{text = '> بازگشت ', callback_data = '/option:'..GP_id}
...
if msg.query and msg.query:match("-%d+") and is_sudo(msg) then
	...
	keyboard.inline_keyboard = {
		{
			{text = ' قابلیتهای ربات ', callback_data = '/lang:'..chatid}
		},
		{
			{text= 'خروج' ,callback_data = '/exit:'..chatid}
		}					
	}
	send_inline(msg.id,'settings','Group Option','Tap Here','لطفاً یکی از گزینه های زیر را انتخاب کنید.!',keyboard)
end
if msg.cb then
...
local lang = redis:get(hash) 
   ...
   elseif lang then
		get_alert(msg.cb_id, "شما به فرمان دادن دسترسی ندارید")
   end
   ...
   elseif lang then
	...
	local text = '_لطفاً_*زبان*_را انتخاب کنید_'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
		...
		{
			{text= '> خروج' ,callback_data = '/خروج:'..matches[2]}
		}				
	}
    edit_inline(msg.message_id, text, keyboard)
	end
...
local keyboard = {} 
		...
		edit_inline(msg.message_id, text, keyboard)
         ...
         -- ####################### About Us ####################### --
if matches[1] == '/poinshtan' then
	local text = _config.info_text
    if not lang then
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = "> مهدی", callback_data="/mehdi:"..matches[2]}, 
		},
		{
			{text = '> Our GitHub ', url = 'https://github.com/poinshtan/poinshtan.bot'}
		},
		{
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = '> گیت هاب تیم ', url = 'https://github.com/poinshtan/poinshtan.bot'}
		},
		{
...
local text = [[bot owner]]
  if not lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			{
				{text = "> Back", callback_data="/poinshtan:"..matches[2]}
			}
		}
  elseif lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			{
				{text = "> بازگشت", callback_data="/poinshtan:"..matches[2]}
			}
		}
  end
    edit_inline(msg.message_id, text, keyboard)
